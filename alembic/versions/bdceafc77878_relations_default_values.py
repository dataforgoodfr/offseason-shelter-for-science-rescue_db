...
def upgrade() -> None:
    ...
    op.alter_column('resources', 'dg_resource_locator_function',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.alter_column('resources', 'dg_resource_locator_protocol',
               existing_type=sa.VARCHAR(),
               nullable=True)
    op.alter_column('resources', 'dg_mimetype',
               existing_type=sa.VARCHAR(),
               nullable=True)
...
def downgrade() -> None:
    ...
    op.add_column('datasets', sa.Column('dg_created', postgresql.TIMESTAMP(), autoincrement=False, nullable=False))
    op.add_column('datasets', sa.Column('dg_organization_id', sa.VARCHAR(), autoincrement=False, nullable=False))
